...
use chess_common::{Piece, PieceKind, Player};
use html_to_string_macro::html;

pub(super) fn create_option_piece_svg(piece: Option<Piece>) -> Html<String> {
...
pub(super) fn get_piece_svg(piece: Piece) -> Html<String> {
